...
public class Controller {
    ...
    private void showForm() {
        ...
        this.mainForm.getjListUsers().setVisible(false);
...
//                Model authenticationModel = new Model(users, mainForm);
                model.handleEvents();
            }
        });
        this.mainForm.getjMenuLoginLogoutLogout().addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                model.logout();
            }
        ...
        mainForm.getjMenuAdministrationUsers().addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                model.showUsers();
            }
